...
export const dolls: Doll[] = [
  {
    ...
    motif: "Star map",
    assetPath: "/images/star-struck.jpg",
    angle: "rotate-[-2deg]",
    cardClass:
  ...
  },
  {
    ...
    motif: "Notebook",
    assetPath: "/images/dictionary-with-legs.jpg",
    angle: "rotate-[1.5deg]",
    cardClass:
  ...
  },
  {
    ...
    motif: "Colour wash",
    assetPath: "/images/inside-out.jpg",
    angle: "rotate-[-1deg]",
    cardClass:
  ...
  },
  {
    ...
    motif: "Shield",
    assetPath: "/images/team-soldiers.jpg",
    angle: "rotate-[2deg]",
    cardClass:
  ...
  },
  {
    ...
    poem: "Discovery arises by looking at the same thing as everyone else and thinking something different.",
    purpose:
    ...
    assetPath: "/images/dr-curious.jpg",
    angle: "rotate-[-2deg]",
    cardClass:
  ...
  },
  {
    ...
    motif: "Monster notes",
    assetPath: "/images/worry-monster.jpg",
    angle: "rotate-[1deg]",
    cardClass:
