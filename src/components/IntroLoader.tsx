    ...
    >
      ...
      {floatingPieces.map((piece, index) => (
        <motion.div
          ...
          transition={{ duration: 2.4, delay: index * 0.08, ease: [0.42, 0, 0.58, 1] as const }}
      ...
      <motion.div
        ...
        transition={{ duration: reduceMotion ? 0.35 : 0.8, delay: 0.15 }}
        className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center"
      >
        <motion.div
          animate={reduceMotion ? undefined : { scale: [1, 1.04, 1], rotate: [0, 1.5, 0] }}
          transition={{ duration: 2.2, repeat: Number.POSITIVE_INFINITY, ease: [0.42, 0, 0.58, 1] as const }}
        ...
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
          transition={{ duration: reduceMotion ? 0.45 : 1.2, delay: 0.25, ease: [0.22, 1, 0.36, 1] }}
